...
- Input port
	...
	command line.  This is needed on EBB6800 boards.  It can also
	be used of override the default port number on non-EBB6800
	systems.
...
When booting on EBB6800 we need to specify the IPD port used by eth0,
if a single quad SGMII module is installed on QLM4 the command would
be:
...
When running on EBB6800 we need to specify the IPD port used by eth0,
if a single quad SGMII module is installed on QLM4 the command would
be:
